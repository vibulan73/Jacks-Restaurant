    ...
    <div className="min-h-screen pt-20">
      ...
      <div className="relative py-32 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1537047902294-62a40c20a6ae?w=1920&q=80')" }}>
        ...
        <div className="relative z-10 text-center">
          <SectionHeader subtitle="Our Story" title="About Jack's Norwood" />
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?w=700&h=500&fit=crop" alt="Restaurant interior" className="rounded-xl w-full object-cover h-96" />
                <div className="absolute -bottom-6 -right-6 bg-pub-gold text-pub-dark p-6 rounded-xl font-display">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map(({ icon: Icon, value, label }, i) => (
              ...
              >
                ...
                <p className="font-display text-5xl font-bold text-white mb-2">{value}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }}
                className="bg-pub-brown/60 border border-white/10 rounded-xl p-8">
                <div className="w-12 h-0.5 bg-pub-gold mb-4 mx-auto"></div>
                <h3 className="font-display text-white text-xl font-semibold mb-3">{title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, i) => (
              ...
              >
                <div className="relative w-36 h-36 mx-auto mb-4 overflow-hidden rounded-full border-2 border-pub-gold/30 group-hover:border-pub-gold transition-all duration-300">
                  <img src={member.img} alt={member.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
                <h3 className="font-display text-white text-lg font-semibold">{member.name}</h3>
      ...
      {/* CTA */}
      <section className="py-20 bg-pub-brown/30 border-y border-pub-gold/20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="section-title mb-4">Come Visit Us</h2>
          <p className="text-white/60 text-lg mb-8">We'd love to have you. Book a table or just walk in — you're always welcome at Jack's.</p>
